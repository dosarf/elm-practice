{- This file re-implements the Elm Counter example (1 counter) with elm-mdl
   ...
   https://www.dailydrip.com/topics/elm/drips/elm-mdl-introduction
-}
...
view model =
    ...
    Material.Scheme.topWithScheme Color.Teal Color.LightGreen <|
        Layout.render Mdl
            ...
            { header = [ h1 [ style [ ( "padding", "1rem" ) ] ] [ text "Counter" ] ]
            , drawer = []
            , tabs = ( [ text "Counting", text "Oranges" ], [] )
            , main = [ viewBody model ]
            }
