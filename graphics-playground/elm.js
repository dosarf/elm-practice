...
var _user$project$Main$square = _evancz$elm_graphics$Collage$path(
	{
		ctor: '::',
...
var _user$project$Main$blueSquare = A2(
	...
	_user$project$Main$square);
var _user$project$Main$squares = function (_p0) {
	var _p1 = _p0;
	var _p3 = _p1._1;
	var _p2 = _p1._0;
	return A3(
		...
		800,
		{
			...
			_0: A2(
				...
				{ctor: '_Tuple2', _0: 0 + _p2, _1: -55 + _p3},
...
var _user$project$Main$view = function (model) {
	return _evancz$elm_graphics$Element$toHtml(
		_user$project$Main$squares(
			{
				ctor: '_Tuple2',
				_0: _elm_lang$core$Basics$toFloat(model.position.x),
				_1: _elm_lang$core$Basics$toFloat(model.position.y)
			}));
};
