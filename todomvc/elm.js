...
var _user$project$Main$activeTodoCount = function (model) {
...
var _user$project$Main$filterTodos = function (model) {
	...
	return A2(_elm_lang$core$List$filter, filterFunction, model.todos);
};
...
var _user$project$Main$newTodo = A4(_user$project$Main$Todo, '', false, false, 0);
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'ToggleComplete':
				var toggleTodo = function (someTodo) {
					return _elm_lang$core$Native_Utils.eq(someTodo.identifier, _p1._0) ? _elm_lang$core$Native_Utils.update(
						someTodo,
						{completed: !someTodo.completed}) : someTodo;
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(_elm_lang$core$List$map, toggleTodo, model.todos)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
			...
			case 'Delete':
				var validTodoFilter = function (t) {
					return !_elm_lang$core$Native_Utils.eq(t.identifier, _p1._0.identifier);
				};
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						todos: A2(_elm_lang$core$List$filter, validTodoFilter, model.todos)
					});
				return {
					ctor: '_Tuple2',
					_0: newModel,
...
var _user$project$Main$mapStorageInput = function (modelJson) {
	var _p4 = _user$project$Main$decodeModel(modelJson);
	if (_p4.ctor === 'Ok') {
		return _user$project$Main$SetModel(_p4._0);
	} else {
		var _p5 = A2(_elm_lang$core$Debug$log, 'Error in mapStorageInput:', _p4._0);
								...
								_1: {
									...
									_1: {
										...
										_0: _elm_lang$html$Html_Events$onCheck(
											function (_p6) {
												return _user$project$Main$ToggleComplete(todo.identifier);
											}),
										_1: {ctor: '[]'}
									}
								}
							...
							},
							{
								...
								_0: A2(
									...
									A2(
										...
										_user$project$Main$filterTodos(model))),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
												...
												{ctor: '[]'},
												{
													...
													_0: _elm_lang$html$Html$text(
														_elm_lang$core$Basics$toString(
															_user$project$Main$activeTodoCount(model))),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
