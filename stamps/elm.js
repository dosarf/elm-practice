...
var _user$project$Stamps$Position = F2(
	function (a, b) {
		return {x: a, y: b};
	});
...
var _user$project$Stamps$initialModel = {
	stamps: {
		ctor: '::',
		_0: A2(
			_user$project$Stamps$Stamp,
			A2(_user$project$Stamps$Position, 200, -100),
			_user$project$Stamps$Pentagon),
		_1: {ctor: '[]'}
	},
	shift: false
};
var _user$project$Stamps$update = F2(
	function (message, model) {
		...
		switch (_p2.ctor) {
			case 'AddClick':
				var newShape = model.shift ? _user$project$Stamps$Pentagon : _user$project$Stamps$Circle;
				var newStamp = A2(_user$project$Stamps$Stamp, _p2._0, newShape);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
			...
			_0: _elm_lang$mouse$Mouse$clicks(
				function (_p5) {
					...
					return _user$project$Stamps$AddClick(
						A2(_user$project$Stamps$Position, _p6.x, -1 * _p6.y));
				}),
			_1: {
				ctor: '::',
...
var _user$project$Stamps$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$Stamps$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
...
if (typeof _user$project$Stamps$main !== 'undefined') {
    _user$project$Stamps$main(Elm['Stamps'], 'Stamps', undefined);
}
