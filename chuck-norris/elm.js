...
var _user$project$Main$formatTimestamp = function (timestamp) {
	var date = _elm_lang$core$Date$fromTime(timestamp);
	return _rluiten$elm_date_extra$Date_Extra_Format$isoString(date);
};
var _user$project$Main$explainHttpError = function (httpError) {
	var _p0 = httpError;
	switch (_p0.ctor) {
		case 'BadUrl':
			return A2(_elm_lang$core$Basics_ops['++'], 'Bad URL: ', _p0._0);
		case 'Timeout':
			return 'Connectiong timed out';
		case 'NetworkError':
...
var _user$project$Main$initialJoke = {id: '0', icon_url: '/pram.jpg', value: 'TODO Chuck Norris'};
var _user$project$Main$initialModel = {joke: _user$project$Main$initialJoke, requestTimestamp: 0.0};
var _user$project$Main$alertHttpError = _elm_lang$core$Native_Platform.outgoingPort(
	'alertHttpError',
	function (v) {
		return v;
	});
var _user$project$Main$Joke = F3(
	function (a, b, c) {
		return {id: a, icon_url: b, value: c};
	});
var _user$project$Main$decodeJokeJson = A3(
	...
	A3(
		...
		A3(
			...
			'id',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Joke))));
var _user$project$Main$Model = F2(
	function (a, b) {
		return {joke: a, requestTimestamp: b};
	});
var _user$project$Main$NewTimestamp = function (a) {
	return {ctor: 'NewTimestamp', _0: a};
};
var _user$project$Main$GotJoke = function (a) {
	return {ctor: 'GotJoke', _0: a};
};
var _user$project$Main$getNextJoke = function () {
	var request = A2(_elm_lang$http$Http$get, 'https://api.chucknorris.io/jokes/random', _user$project$Main$decodeJokeJson);
	return A2(_elm_lang$http$Http$send, _user$project$Main$GotJoke, request);
}();
		...
		switch (_p3.ctor) {
			case 'NextJoke':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							ctor: '::',
							_0: _user$project$Main$getNextJoke,
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$core$Task$perform, _user$project$Main$NewTimestamp, _elm_lang$core$Time$now),
								_1: {ctor: '[]'}
							}
						})
				};
			case 'GotJoke':
				if (_p3._0.ctor === 'Ok') {
					...
					var _p5 = _p3._0._0;
					var _p4 = A2(_elm_lang$core$Debug$log, 'HTTP error: ', _p5);
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$Main$alertHttpError(
							_user$project$Main$explainHttpError(_p5))
					};
				}
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{requestTimestamp: _p3._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Main$NextJoke = {ctor: 'NextJoke'};
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$NextJoke),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Kickme'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(_elm_lang$core$Basics_ops['++'], 'Joke id: ', model.joke.id)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(model.joke.value),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Requested at: ',
										_user$project$Main$formatTimestamp(model.requestTimestamp))),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$src(model.joke.icon_url),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
